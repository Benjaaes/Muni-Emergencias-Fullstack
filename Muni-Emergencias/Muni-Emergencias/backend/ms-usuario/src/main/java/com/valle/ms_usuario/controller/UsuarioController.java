...
public class UsuarioController {
    ...
    public ResponseEntity<?> login(@RequestBody UsuarioDTO credenciales) {
        ...
        // Aquí deberías llamar a tu UsuarioService para validar si el correo y contraseña son correctos.
        // Ejemplo ficticio: return service.login(credenciales.getEmail(), credenciales.getPassword());
        
        // Por ahora, devolvemos un OK genérico para que veas que la conexión ya funciona y React avance.
